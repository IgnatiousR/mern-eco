    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-blue-50 rounded-3xl">
        ...
        <div className="lg:w-1/2 p-8 text-center lg:text-left">
          <h2 className="text-lg font-semibold text-zinc-700 mb-2">Comfort and Style</h2>
          <h2 className="text-4xl lg:txt-5xl font-bold mb-6">
          ...
          <Link
            to="/collections/all"
            className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-zinc-800"
          >
            Shop Now
          </Link>
        </div>
